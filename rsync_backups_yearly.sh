...
export LANG=C.UTF-8
# =============================================================================
#          file: /home/victoria/backups/rsync/rsync_backups_yearly.sh
#         title: HOURLY rsync backup script
#       created: 2020-04-29
#       version: 02
# last modified: 2020-05-12 08:18:28 -0700 (PST)
#      versions:
#         * v01: inaugural
#         * v02: 
...
printf "`date +'%Y-%m-%d (%H:%M:%S)'`: START YEARLY\n"

# INCREMENT:
printf "`date +'%Y-%m-%d (%H:%M:%S)'`: cp yearly.x --> yearly.x+1\n"
# rm -fr /mnt/Backups/rsync_backups/yearly.12
# Last dozen years:
mv 2>/dev/null /mnt/Backups/rsync_backups/yearly.11/ /mnt/Backups/rsync_backups/yearly.12
mv 2>/dev/null /mnt/Backups/rsync_backups/yearly.10/ /mnt/Backups/rsync_backups/yearly.11
mv 2>/dev/null /mnt/Backups/rsync_backups/yearly.09/ /mnt/Backups/rsync_backups/yearly.10
mv 2>/dev/null /mnt/Backups/rsync_backups/yearly.08/ /mnt/Backups/rsync_backups/yearly.09
mv 2>/dev/null /mnt/Backups/rsync_backups/yearly.07/ /mnt/Backups/rsync_backups/yearly.08
mv 2>/dev/null /mnt/Backups/rsync_backups/yearly.06/ /mnt/Backups/rsync_backups/yearly.07
mv 2>/dev/null /mnt/Backups/rsync_backups/yearly.05/ /mnt/Backups/rsync_backups/yearly.06
mv 2>/dev/null /mnt/Backups/rsync_backups/yearly.04/ /mnt/Backups/rsync_backups/yearly.05
mv 2>/dev/null /mnt/Backups/rsync_backups/yearly.03/ /mnt/Backups/rsync_backups/yearly.04
mv 2>/dev/null /mnt/Backups/rsync_backups/yearly.02/ /mnt/Backups/rsync_backups/yearly.03
mv 2>/dev/null /mnt/Backups/rsync_backups/yearly.01/ /mnt/Backups/rsync_backups/yearly.02
mv 2>/dev/null /mnt/Backups/rsync_backups/yearly.00/ /mnt/Backups/rsync_backups/yearly.01

# COPY:
printf "`date +'%Y-%m-%d (%H:%M:%S)'`: cp monthly.11 --> yearly.00\n"
# https://stackoverflow.com/questions/1529946/linux-copy-and-create-destination-dir-if-it-does-not-exist
cp 2>/dev/null -al /mnt/Backups/rsync_backups/monthly.11/ /mnt/Backups/rsync_backups/yearly.00

printf "`date +'%Y-%m-%d (%H:%M:%S)'`: END YEARLY\n"
